/*global window,$,angular,console,sessionStorage*/
...
filmControllers.controller('FilmListCtrl', ['$scope', 'Film',
    function ($scope, Film) {
        'use strict';
...
filmControllers.controller('CartCtrl', ['$scope', 'Film', 'Order', 'WebSocket',
    function ($scope, Film, Order, WebSocket) {
        'use strict';
        ...
        $scope.order = function () {
            ...
            if (order.items.length) {
                Order.query(order, function () {
                    ...
                    var message = "Les films " + titres.join(", ") + " viennent d'être commandé par quelqu'un d'autre!";
                    if (titres.length === 1) {
                        message = "Le film " + titres.join(", ") + " vient d'être commandé par quelqu'un d'autre!";
                    }
